# Development Backlog — Index

Active feature backlogs and deferred work. **Product specifications** are in [`../specification/`](../specification/).

---

## Feature backlogs

| Backlog | Topic | Status (2026-07-07) |
|---|---|---|
| [`backlog-faq.md`](./backlog-faq.md) | Help & FAQ — public Q&A, committee editing | **41 done** · 0 remaining · [archive](./archive/faq-archived-2026-07-07.md) |
| [`backlog-staff-registry.md`](./backlog-staff-registry.md) | Staff registry + important contacts | **68 done** · 28 on hold · [archive](./archive/staff-registry-archived-2026-07-07.md) |
...
*For product context see [Functional Spec](../specification/functional-spec.md) and [Product Roadmap](../specification/product-roadmap.md).*
