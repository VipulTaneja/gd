...
import { Heart, Home, Users, Briefcase } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <FadeIn>
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center gap-2 rounded-full bg-gold/10 px-4 py-2 text-sm font-medium text-gold mb-4">
