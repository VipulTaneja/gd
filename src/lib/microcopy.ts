...
export const empty = {
  ...
  communitiesLeader: { title: "You're not leading any communities", description: "When you're made a community leader, those groups will show up here." },
  communitiesMember: { title: "You're not a member of any communities yet", description: "Browse the full list and join a group that fits you." },
  communitiesBrowse: { title: "Nothing left to browse", description: "You're already part of every community on the list." },
